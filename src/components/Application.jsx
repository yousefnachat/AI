  ...
  return (
    <section id="Application" className="w-[90%] m-auto">
      ...
      <div className="flex justify-center items-center">
        <div class="grid sm:grid-cols-4 gap-4 w-full max-w-4xl">
      ...
      <div className="grid grid-cols-12 gap-4 mt-16">
        ...
        <div className="sm:col-span-7 col-span-12 rounded-lg p-4 flex flex-col sm:flex-row justify-center gap-4 text-white">
          <div
            id="hero"
            className="col-span-12 sm:col-span-6 rounded-lg p-4 backdrop-blur-xl bg-[#58585861]"
          >
            <div>
